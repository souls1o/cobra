...
from bot.handlers.commands import start, help, setup, check_balance, post_tweet, delete_tweet, display_users, display_endpoint, display_whitelist, set_client_id, set_client_secret, set_redirect, set_spoof, set_replies, check_auth
...
def main():
    ...
    app.add_handler(check_balance.get_handler())
